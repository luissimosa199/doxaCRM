...
const DoxaEmail: FunctionComponent<EmailProps> = ({ name, slug, id }) => {
  return (
    <Html>
        ...
        <Body className="bg-[#f9fafe] my-auto mx-auto font-sans pb-4">
          ...
          <Section className="my-6">
            ...
            <Link
              ...
              className="bg-[#0083ef] flex text-lg w-fit mx-auto font-semibold  text-white py-2 px-4 rounded-full no-underline"
            >
